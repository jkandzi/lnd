...
type Invoice struct {
	// *
	// An optional memo to keep with the invoice. Only for record keeping
	// purposes, use the description field to attach a description to the
	// payment request.
	...
	// *
	// Short description of the payment, which will be encoded withing the payment
	// request. Must be set if an only if description_hash is not set.
	Description string `protobuf:"bytes,10,opt,name=description" json:"description,omitempty"`
	// *
	// Hash (SHA256) of a description of the payment. Used if the description of
	// payment is too long to naturally fit within the description field. Must be
	// set if an only if description is not set.
	DescriptionHash []byte `protobuf:"bytes,11,opt,name=description_hash,proto3" json:"description_hash,omitempty"`
}
...
type PayReq struct {
	...
	DescriptionHash string `protobuf:"bytes,5,opt,name=description_hash" json:"description_hash,omitempty"`
}
...
var fileDescriptor0 = []byte{
	...
	,
}
